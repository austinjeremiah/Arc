...
headers = {"Authorization": "Bearer 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"}
...
def handle_userinput(user_question, image_caption):
    ...
    universalprompt = "Assume me that im a high level electronic engineer so give me the answer more and more technical that only high experience people can understand and also dont mention anywhere about me just give answer.question is "
...
def main():
    load_dotenv()
    st.set_page_config(page_title="Chat with us", page_icon=":books:")
    ...
    st.header("Ask Anything about your product:books:")
